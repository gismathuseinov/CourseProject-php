...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('Projct/assets/images/favicon.png')}}">
...
<div class="main-wrapper">
    ...
    <div class="error-box">
        <div class="error-body text-center">
            ...
            <a href="admin" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Back to home</a></div>
    </div>
    <!-- ============================================================== -->
    <!-- Login box.scss -->
    <!-- ============================================================== -->
