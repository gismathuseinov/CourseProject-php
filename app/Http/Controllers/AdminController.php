...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        $postTitles = Complaint::with(['comments'])->orderByDesc('id')
            ->where('is_letted', 1)->paginate(4);

        return view('admin-panel.nice-html.ltr.index', compact(['userCount', 'unReadMessage', 'newComplaint', 'users', 'postTitles']));
    }
    ...
    public function message()
    {
        ...
        return view('admin-panel.nice-html.ltr.message', compact('feedback'));
    }
